...
function SignUpFrom() {
    ...
    return (
        <form className='grid-cols-2 grid gap-3 p-2 ml-[304px] w-full shadow  border rounded-md'>
            <Input label="First Name" startContent={<UserIcon className='w-4' />} />
            <Input label="Last Name" startContent={<UserIcon className='w-4' />} />
            <Input className='col-span-2' label="Email" startContent={<EnvelopeOpenIcon className='w-4' />} />
            <Input className='col-span-2' label="Phone" startContent={<PhoneIcon className='w-4' />} />
            <Input className='col-span-2' label="Password" endContent={
            ...
            <Input className='col-span-2' label="Confrim Password" type={isVisiblePass ? "text" : "password "} startContent={<KeyIcon className='w-4' />} />
            <Checkbox>Accpet the<Link href="/terms">Terms</Link></Checkbox>
